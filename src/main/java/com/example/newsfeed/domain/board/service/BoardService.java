...
public class BoardService {
    ...
    public List<FeedResponseDto> findBoardFollowerAll(Long userId, int limit) {

        return boardRepository.findBoardFollowerAll(userId, limit).stream().map(FeedResponseDto::toDto).toList();
    }
